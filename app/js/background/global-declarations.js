        ...
        window._getCurrentTabIndex = function (id, currentTab, listener) {
            if (currentTab === 'background') {
                ...
                listener(GlobalDeclarations.modules.crmValues.tabData.get(currentTab)
                    .nodes.get(id).map(function (element, index) {
                    return index;
                }));
            }
        };
    ...
    function init() {
        ...
        function onTabUpdated(id, changeInfo, tab) {
            if (changeInfo.status && changeInfo.status === 'loading' &&
                ...
                for (var _i = 0, _a = GlobalDeclarations.modules.toExecuteNodes.always.documentStart; _i < _a.length; _i++) {
                    var id_1 = _a[_i].id;
                    GlobalDeclarations.modules.CRMNodes.Running.executeNode(GlobalDeclarations.modules.crm.crmById.get(id_1), tab);
                }
                for (var _b = 0, _c = GlobalDeclarations.modules.toExecuteNodes.onUrl.documentStart; _b < _c.length; _b++) {
                    var _d = _c[_b], id_2 = _d.id, triggers = _d.triggers;
                    if (GlobalDeclarations.modules.URLParsing.matchesUrlSchemes(triggers, tab.url)) {
                        GlobalDeclarations.modules.CRMNodes.Running.executeNode(GlobalDeclarations.modules.crm.crmById.get(id_2), tab);
                    }
                }
            }
        }
        ...
        function listenTamperMonkeyInstallState() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, updateTamperMonkeyInstallState()];
                        case 1:
                            _a.sent();
