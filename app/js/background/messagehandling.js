                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'updateStylesheet': return [3, 19];
                            case 'updateScripts': return [3, 20];
                            case 'installUserScript': return [3, 22];
                            case 'applyLocalStorage': return [3, 24];
                            case 'getStyles': return [3, 25];
                            case '_resetSettings': return [3, 28];
                        }
                        return [3, 30];
                    case 1:
                    ...
                    case 15:
                        ...
                        return [4, MessageHandling.modules.CRMNodes
                                .Running.executeScriptsForTab(messageSender.tab.id, respond)];
                    case 16:
                        response = _b.sent();
                        _b.label = 17;
                    case 17: return [3, 30];
                    case 18:
                        ...
                        return [3, 30];
                    case 19:
                        MessageHandling.modules.CRMNodes.Stylesheet.Updating.updateStylesheet(message.data.id);
                        return [3, 30];
                    case 20: return [4, MessageHandling.modules.CRMNodes.Script.Updating.updateScripts()];
                    case 21:
                        response = _b.sent();
                        return [3, 30];
                    case 22: return [4, MessageHandling.modules.CRMNodes.Script.Updating.install(message.data)];
                    case 23:
                        _b.sent();
                        return [3, 30];
                    case 24:
                        ...
                        return [3, 30];
                    case 25:
                        if (!(messageSender && respond)) return [3, 27];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        MessageHandling.modules.Util.iterateMap(tabData, function (tabId, _a) {
                            var nodes = _a.nodes;
