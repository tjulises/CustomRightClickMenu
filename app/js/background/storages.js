...
(function (Storages) {
    ...
    (function (SetupHandling) {
        function getDefaultStorages() {
            return __awaiter(this, void 0, void 0, function () {
                var syncStorage, syncHash, useAsUserscriptManager, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3: return [2, [(_a.lastUpdatedAt = (_b.sent()).version,
...
(function (Storages) {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 2:
                        ...
                        node = same_1[_i];
                        currentValue = Storages.modules.crm.crmById.get(node.id);
                        _c = node.type === 'script';
                        if (!_c) return [3, 6];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        if (!(!Storages.modules.storages.storageLocal.useStorageSync || !supportsStorageSync())) return [3, 3];
                        return [4, browserAPI.storage.local.set({
                    ...
                    case 2:
                        ...
                        return [3, 9];
                    case 3:
                        if (!(settingsJson.length >= 101400 || !supportsStorageSync())) return [3, 6];
                        return [4, browserAPI.storage.local.set({
                                useStorageSync: false
                            })];
                    case 4:
    ...
    function loadStorages() {
        var _this = this;
        return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            var storageSync, _a, storageLocal, result, data, storageLocalCopy, settingsStorage, indexes, settingsJsonArray_1, indexesLength, jsonString, indexes, settingsJsonArray_2, indexesLength, jsonString;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    function isVersionInRange(min, max, target) {
        var maxObj = getVersionObject(max);
        var minObj = getVersionObject(min);
        var targetObj = getVersionObject(target);
