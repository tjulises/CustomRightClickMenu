            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 5: return [2, ChromeAPIs.getURL(message, fn)];
                        case 6: return [2, ChromeAPIs.unaccessibleAPI(message)];
                        case 7: return [2, ChromeAPIs.reload(message, fn)];
                        case 8: return [2, ChromeAPIs.restart(message, fn)];
                        case 9: return [2, ChromeAPIs.restartAfterDelay(message, fn)];
