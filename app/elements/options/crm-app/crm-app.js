...
(function (CRMAppElement) {
    ...
    (function () {
        ...
        function areConfigsEqual(first, second) {
        ...
        function areTimingsEqual(reusedOptions, newOptions) {
            var reusedDuration = reusedOptions.duration, reusedEasing = reusedOptions.easing, reusedFill = reusedOptions.fill;
            var newDuration = newOptions.duration, newEasing = newOptions.easing, newFill = newOptions.fill;
            return reusedDuration === newDuration &&
                reusedEasing === newEasing &&
                reusedFill === newFill;
        }
        function attemptReUse(element, properties, options) {
            if ('transform' in properties[0] || 'transform' in properties[1]) {
                return null;
            }
            for (var _i = 0, usedAnimations_1 = usedAnimations; _i < usedAnimations_1.length; _i++) {
                var _a = usedAnimations_1[_i], animationElement = _a[0], animation = _a[1];
                if (animationElement === element) {
                    var _b = areConfigsEqual(animation.properties, properties), equal = _b.equal, reverse = _b.reverse;
                    var timingsEqual = areTimingsEqual(animation.options, options);
        ...
        function doAnimation(element, properties, options) {
            var animation = animateImpl.apply(element, [properties, options]);
            usedAnimations.push([element, {
                    animation: animation, element: element, properties: properties,
                    state: 'completed',
                    options: options
                }]);
            return animation;
        ...
        HTMLElement.prototype.animateTo = function (properties, options) {
            var currentProps = {};
            for (var prop in properties) {
                currentProps[prop] = this.style[prop];
            }
            return this.animate([currentProps, properties], options);
        };
        if (!animateExists) {
    ...
    var CA = (function () {
        ...
        CA.domListener = function (event) {
            ...
            var fnName;
            var pathIndex = 0;
            var currentElement = window.app.util.getPath(event)[pathIndex];
            while (!('getAttribute' in currentElement) ||
                !(fnName = currentElement.getAttribute(propKey)) &&
        ...
        CA._currentItemIsCss = function (item) {
        ...
        CA.setLocal = function (key, value) {
            ...
            browserAPI.storage.local.get().then(function (storageLocal) {
                ...
                if (key === 'simpleMode') {
                    _this.setSimpleMode(value);
                }
            });
            var _a;
        };
        ;
        CA.animateElementOut = function (element) {
        ...
        CA.setSimpleMode = function (enabled) {
        ...
        CA._checkConstraints = function (data, value, optionals, errors) {
        ...
        CA.typeCheck = function (data, toCheck, errors) {
            var optionals = {};
            for (var i = 0; i < toCheck.length; i++) {
                var data_1 = toCheck[i];
                if (!this.dependencyMet(data_1, optionals)) {
                    continue;
                }
                var value = this._getDotValue(data_1, data_1.val);
                var isDefined = this._isDefined(data_1, value, optionals, errors);
                if (isDefined === true) {
                    var matchedType = this._typesMatch(data_1, value, errors);
                    if (matchedType) {
                        optionals[data_1.val] = true;
                        this._checkConstraints(data_1, value, optionals, errors);
                        continue;
                    }
                }
        ...
        CA._transferFromOld = (function () {
            ...
            CRMAppTransferFromOld._execFile = function (path) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, window.app.util.xhr(path, true)];
                            case 1:
                                fileContent = _a.sent();
                                eval(fileContent);
                                return [2];
        ...
        CA._setup = (function () {
            ...
            CRMAppSetup.setupStorages = function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    var parent, storageLocal, editing_1, versionData, toast;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                parent = this.parent();
        ...
        CA.listeners = (function () {
            ...
            CRMAppListeners.iconSwitch = function (e, types) {
                var i;
                var crmEl;
                var selectedTypes = this.parent().crmTypes.slice();
                if (Array.isArray(types)) {
                    for (i = 0; i < 6; i++) {
                        crmEl = this.parent().shadowRoot.querySelectorAll('.crmType')[i];
                        if (types[i]) {
                ...
                for (var i_2 = 0; i_2 < 6; i_2++) {
                    if (this.parent().crmTypes[i_2] !== selectedTypes[i_2]) {
                        this.parent().fire('crmTypeChanged', {});
                        break;
                    }
                }
            ...
            ;
            CRMAppListeners._getDownloadPermission = function () {
                var _this = this;
                return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                    var granted, allowed;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4, browserAPI.permissions.contains({
                                        permissions: ['downloads']
                                    })];
                            case 1:
                                granted = _a.sent();
                                if (!granted) return [3, 2];
                                resolve(true);
                                return [3, 4];
                            case 2: return [4, browserAPI.permissions.request({
                                    permissions: ['downloads']
                                })];
                            case 3:
                                allowed = _a.sent();
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4, this._getDownloadPermission()];
                            case 1:
                                if (_a.sent()) {
        ...
        CA.util = (_b = (function () {
                ...
                CRMAppUtil.findElementWithTagname = function (event, tagName) {
                    var index = 0;
                    var path = this.getPath(event);
                    var node = path[0];
                    while (!('tagName' in node) || node.tagName.toLowerCase() !== tagName) {
                        node = path[++index];
                ...
                CRMAppUtil.findElementWithClassName = function (event, className) {
                    ...
                    var path = this.getPath(event);
                    var node = path[0];
                    while (!('classList' in node) || !node.classList.contains(className)) {
                        node = path[++index];
                        if (index >= path.length) {
                            return null;
                        }
