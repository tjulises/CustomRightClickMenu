...
(function (ScriptEditElement) {
    ...
    var SCE = (function () {
        ...
        ;
        SCE._saveEditorContents = function (mode) {
        ...
        SCE.editorLoaded = function () {
            ...
            editorManager.getTypeHandler()[0].listen('metaChange', function (oldMetaTags, newMetaTags) {
        ...
        ;
        SCE.loadEditor = function (content, disable) {
