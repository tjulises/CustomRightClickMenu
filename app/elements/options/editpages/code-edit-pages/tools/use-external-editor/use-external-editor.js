    ...
    var UEE = (function () {
            ...
            if (!this.appPort) {
                ...
                Promise.race([
                    ...
                    if (res === false) {
                        ...
                        _this.connection.id = res.connectionId;
                    }
                });
            }
        };
        ...
        UEE.onDialogMainDivAnimationHideEnd = function (dialogRect, dialogStyle, oldScript, newScript) {
            ...
            this.playIfExists(this.dialogExpansionAnimation) ||
                (this.dialogExpansionAnimation = this.doCSSAnimation(window.doc.externalEditorChooseFile, [{
                    ...
                    _this.playIfExists(_this.dialogComparisonDivAnimationShow) ||
                        (_this.dialogComparisonDivAnimationShow = _this.doCSSAnimation(window.doc.chooseFileMerger, [{
                                marginTop: '70px',
                                opacity: 0
                            }, {
                                marginTop: '0px',
                            ...
                            if (!_this.editorManager) {
                                setTimeout(function () {
                                    _this.initEditor(oldScript, newScript);
                                }, 150);
                            }
                        }));
                }));
        ...
        UEE.showMergeDialog = function (oldScript, newScript) {
            ...
            this.dialogMainDivAnimationHide.onfinish = function () {
                _this.onDialogMainDivAnimationHideEnd(dialogRect, dialogStyle, oldScript, newScript);
            };
        };
        ;
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            window.doc.chooseFileChooseCRM.addEventListener('click', function () {
                                var editor = _this.editorManager.editor;
                                if (_this.editorManager.isDiff(editor)) {
