...
(function (NodeEditBehaviorNamespace) {
    ...
    var NEB = (function () {
        ...
        NEB._changeType = function (type) {
            ...
            this.cancel();
            var editCrmEl = window.app.editCRM.getCRMElementFromPath(this.item.path, false);
    ...
    Polymer.NodeEditBehavior = Polymer.NodeEditBehavior || NodeEditBehaviorNamespace.NEB;
