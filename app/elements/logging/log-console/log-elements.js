                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [3, 4];
                        case 1: return [4, browserAPI.tabs.get(~~this.props.line.tabId)["catch"](function (err) {
    ...
    var LogLine = (function (_super) {
        ...
        LogLine.prototype.takeToTab = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, browserAPI.tabs.get(~~this.props.line.tabId)["catch"](function (err) {
                                window.logConsole.$.genericToast.text = 'Tab has been closed';
                                window.logConsole.$.genericToast.show();
                            })];
                        case 1:
