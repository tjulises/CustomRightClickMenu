...
(function (LogConsoleElement) {
    ...
    var LC = (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4, browserAPI.tabs.get(~~tabId)["catch"](function (err) {
        ...
        LC._refreshMenu = function (menu, template) {
            ...
            menu.onValueChange = function (oldState, newState) {
                _this._closeMenus();
                switch (menu.id) {
                    case 'idDropdown':
        ...
        LC.ready = function () {
            ...
            this._logLines = ReactDOM.render(React.createElement(window.logElements.logLines, {
                items: [],
                logConsole: this
            }), this.$.lines);
