...
;
function checkConstraints(data, value, optionals) {
        ...
        describe('#setContentTypes()', function () {
            it('should set the entire array when passed a correct one', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            testArr = [false, false, false, false, false, false].map(function (val) {
                                ...
                                return [2, new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    called = 0;
                                                    return [4, crmAPI.browser.alarms.onAlarm.addListener.p(function (value) {
                                                            called += 1;
                                                            if (called === 3) {
                                                                resolve(null);
                                                            }
