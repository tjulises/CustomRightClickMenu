...
function beforeUserscriptInstall(prefix, url) {
...
function beforeUserstyleInstall(prefix, url) {
    it('should be possible to navigate to the page', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
function installStylesheetFromInstallPage(getConfig) {
    it('should have been installed into the CRM', function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, prefix, href, descriptor, parsed, crm, _b, _c, node;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        this.timeout(600000 * TIME_MODIFIER);
...
function doOpenUserJsTest(prefix) {
    describe('Installing from OpenUserJS', function () {
        var URL = 'https://openuserjs.org/scripts/xthexder/Wide_Github';
        var href;
        var title;
        beforeUserscriptInstall(prefix, URL);
        it('should be possible to click the install link', function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            this.timeout(600000 * TIME_MODIFIER);
                            this.slow(600000 * TIME_MODIFIER);
                            return [4, driver.get('https://www.github.com/login')];
                        case 1:
                            _c.sent();
                            return [4, imports_1.wait(5000)];
                        case 2:
                        ...
                        case 3:
                            _b.apply(_a, [_c.sent(), '980px', 'width was changed (script was applied)']);
                            return [2];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 3:
                            _b.apply(_a, [_c.sent(), 'rgba(0, 0, 0, 0)', 'background color changed (script is applied)']);
                            return [2];
                    }
                });
            });
