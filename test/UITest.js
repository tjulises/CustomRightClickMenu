...
var SKIP_DIALOG_TYPES_EXCEPT = getSkipDialogSetting();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4: return [4, enableTestLogging()];
                case 5:
                    _a.sent();
                    return [2];
            }
...
function getActiveTabs() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4, imports_1.executeAsyncScript(imports_1.inlineAsyncFn(function (ondone, onreject, REPLACE) {
                        REPLACE.getBackgroundPageTestData().then(function (testData) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.active = true;
                        _a = this;
                        return [4, imports_1.executeAsyncScript(imports_1.inlineAsyncFn(function (done, onReject, REPLACE) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4, firstElement.findElement(webdriver.By.tagName('paper-button')).click()];
                            case 2:
                                _a.sent();
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4, elements[index].findElement(webdriver.By.tagName('paper-button')).click()];
                            case 2:
                                _a.sent();
                                    ...
                                    return __generator(this, function (_c) {
                                        switch (_c.label) {
                                            ...
                                            case 30:
                                                ...
                                                return [4, imports_1.executeAsyncScript(imports_1.inlineAsyncFn(function (ondone, onreject, REPLACE) {
                                                        REPLACE.getTestData()._clearExecutedScripts();
                                                        REPLACE.getBackgroundPageTestData().then(function (testData) {
                                ...
                                it('should be able to add one from your visited websites', function () { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 7:
                                                _a.sent();
                                                return [4, searchDialog.findElement(webdriver.By.id('manulInputSavedChoice'))
                                                        .click()];
                                            case 8:
                                                _a.sent();
                                                return [4, imports_1.wait(500)];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            ...
                            assert.strictEqual(executedScripts[0].id, tabId, 'stylesheet was executed on the right tab');
        ...
        if (!TEST_EXTENSION) {
            it('should actually be applied to the page', function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, driver.executeScript(imports_1.inlineFn(function (args) {
