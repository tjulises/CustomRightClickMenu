...
var versions = require('../app/elements/change-log/changelog');
...
function getFromTo(_a) {
    var fromAllToAllInput = _a.fromAllToAllInput, allToCurrent = _a.allToCurrent, allToLatest = _a.allToLatest;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4, imports_1.executeAsyncScript(imports_1.inlineAsyncFn(function (done, reject, REPLACE) {
                                        var data = {
...
(function () {
    ...
    runs.forEach(function (_a, index) {
